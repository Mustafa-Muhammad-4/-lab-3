...
let coin = new Coin("Mustafa", 100, N, E);
console.log(chalk.blue(`✔ Created coin for: Mustafa`));
console.log(chalk.blue(`💰 Amount: 100 units`));
console.log(chalk.blue(`🔑 Coin ID: ${coin.guid}`));
console.log(chalk.gray("----------------------------------------"));

// Bank operations: Blind and sign coin
console.log(chalk.green.bold("\n=== Bank Operations ==="));
coin.blind();
const signature = blindSignatures.sign({ blinded: coin.blinded, key: BANK_KEY });
coin.signature = signature;
coin.unblind();
console.log(chalk.green("✓ Coin signed and unblinded successfully"));
console.log(chalk.gray("----------------------------------------"));

// Merchant Transactions: Merchant 1 accepting the coin
...
console.log("Merchant 2 accepting the same coin...");
...
// Functions to handle coin verification and double-spending detection
